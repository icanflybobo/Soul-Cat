...
Soul Cat区别于传统的概括式角色扮演，通过人生经历来模仿真实的人
...
- **异步记忆更新**：记忆沉淀不阻塞主流程
### 说明
2025/6/24 V1.0.0 版本说明
- 当前没有设计持久化，只有基础的架构设计，目前只是简单的demo，目前数据保存在 data/ 目录下：
characters.json - 角色配置
chat_sessions.json - 聊天历史
user_profiles.json - 用户画像
- api配置参考.env.example，填入后另存为.env

## 许可证

本项目采用自定义许可协议，详见 [LICENSE](LICENSE) 文件。

**重要提示**：未经版权方书面授权，禁止将本软件用于任何商业目的。如需商业使用授权，请联系版权方。
